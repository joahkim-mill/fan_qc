...
#     z_accel.append(accelerometer.acceleration[0])
...
def imu_integrator():
    ...
    while while_loop:
        try:
            ax,ay,az = accelerometer.acceleration # read and convert mpu6050 data
...
#
    ...
    # data = np.array([get_accel() for ii in range(0,5)]) # new values
